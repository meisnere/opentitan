...
// Note: Entropy sync logic moved to ast_main.sv with clock oscillators

///////////////////////////////////////
// Entropy and RNG - Moved to ast_main.sv for domain split
// Outputs received from main_to_aon_i interface
///////////////////////////////////////
// RNG outputs from main domain
assign rng_b_o = main_to_aon_i.rng_b;
assign rng_val_o = main_to_aon_i.rng_val;

// Entropy request from main domain
assign entropy_req_o = main_to_aon_i.entropy_req;
///////////////////////////////////////
// Alerts (Always ON)
///////////////////////////////////////
...
assign aon_to_main_o.aon_osc_cal = aon_osc_cal;
