...
ast_entropy u_entropy (
  ...
  .rst_src_sys_ni ( aon_to_main_i.clk_rst.rst_sys_clk_n ),
...
// Clock outputs
assign main_to_aon_o.clk_src_sys = clk_src_sys_o;
assign main_to_aon_o.clk_src_sys_val = clk_src_sys_val_o;
assign main_to_aon_o.clk_src_io = clk_src_io_o;
assign main_to_aon_o.clk_src_io_val = clk_src_io_val_o;
assign main_to_aon_o.clk_src_io_48m = clk_src_io_48m_o;
assign main_to_aon_o.clk_src_usb = clk_src_usb_o;
assign main_to_aon_o.clk_src_usb_val = clk_src_usb_val_o;

// Clock bypass acknowledgements
assign main_to_aon_o.io_clk_byp_ack = io_clk_byp_ack_o;
assign main_to_aon_o.all_clk_byp_ack = all_clk_byp_ack_o;
...
// RNG outputs
assign main_to_aon_o.rng_b = rng_b_o;
assign main_to_aon_o.rng_val = rng_val_o;

// Entropy request
assign main_to_aon_o.entropy_req = entropy_req_o;
...
// RNG
`ASSERT_KNOWN(RngBKnownO_A, rng_b_o, aon_to_main_i.clk_rst.clk_ast_rng, aon_to_main_i.clk_rst.rst_ast_rng_n)
`ASSERT_KNOWN(RngValKnownO_A, rng_val_o, aon_to_main_i.clk_rst.clk_ast_rng, aon_to_main_i.clk_rst.rst_ast_rng_n)
// ES
